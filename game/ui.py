...
class GUI(tk.Frame):
    ...
    def create_widgets(self):
        ...
        self.canvas = tk.Canvas(self.life_grid, height=275, \
                                width=490, borderwidth=1)
        ...
        self.rows_entry = tk.Entry(self.toolbar, width=5, \
                          textvariable=self.rows_text)
        ...
        self.columns_entry = tk.Entry(self.toolbar, width=5, \
                             textvariable=self.columns_text)
        ...
        self.ratio_entry = tk.Entry(self.toolbar, width=5, \
                           textvariable=self.ratio_text)
        ...
        self.start_button = tk.Button(self.toolbar, \
    ...
    def setup_screen(self, board):
        ...
        for x in xrange(board.rows):
            for y in xrange(board.cols):
                ...
                tag = '{},{}'.format(x, y)
                self.canvas.create_rectangle(y0, x0, y1, x1, fill=color, \
                                             tags=tag)
    ...
    def tick(self):
        ...
        for y, row in enumerate(old_grid):
            for x, c in enumerate(row):
                ...
                should_live = neighbours_alive == 3 or (neighbours_alive == 2 \
